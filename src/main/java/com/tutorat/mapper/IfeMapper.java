...
@Service
@AllArgsConstructor
public class IfeMapper {

    private static final Logger logger = LoggerFactory.getLogger(IfeMapper.class);

    public Ife objReqToEntity(IfeRequest req, Ife entity) throws BusinessResourceException {
        try{
