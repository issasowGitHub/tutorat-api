...
public class SerieMapper {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SerieMapper.class);

    public Serie objReqToEntity(SerieRequest req, Serie entity) throws BusinessResourceException {
        try{
