...
@Service
@AllArgsConstructor
public class ModeEncadrementMapper {

    private static final Logger logger = LoggerFactory.getLogger(ModeEncadrementMapper.class);

    public ModeEncadrement objReqToEntity(ModeEncadrementRequest req, ModeEncadrement entity) throws BusinessResourceException {
        try{
