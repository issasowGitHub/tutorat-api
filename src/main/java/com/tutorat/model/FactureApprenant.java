...
@NoArgsConstructor
@AllArgsConstructor
@Entity(name = "facture_apprenant")
@Table(name = "facture_apprenants")
public class FactureApprenant implements Serializable{
    ...
    private Collection<FactureActivite> factures;
